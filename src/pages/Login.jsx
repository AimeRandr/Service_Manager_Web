                ...
                {/* Section Droite */}
                 <div className="md:w-1/2 bg-white w-full h-full flex justify-center items-center p-4">
                    <div className="flex text-black justify-center items-center p-4 my-10 md:my-0 md:mt-30 md:mb-30 md:mr-[max(0px,calc(50vw-680px))] bg-gradient-to-tr from-[#FFFFFF]/[4%] via-[#A3A3A3]/[15%] to-[#FFFFFF]/[4%] md:shrink-0 w-11/12 sm:w-auto md:w-170 md:h-[min(780px,85vh)] border border-[#E3E3E3] shadow-lg max-w-full">
                        {/* Remplacement de h-[70svh] et md:w-[50svh] par des classes plus flexibles pour éviter que le contenu ne déborde sur petit écran */}
                        <div className="p-6 md:pb-10 md:px-20 justify-center bg-white md:mx-25 md:my-10 w-full sm:max-w-md min-h-fit md:h-auto border border-white rounded-3xl flex flex-col items-center">
                            
                            {/* L'icône se réduit sur mobile (w-16 h-16) et grandit sur bureau (md:w-20 md:h-20) */}
                            <div className="flex shrink-0 justify-center items-center w-16 h-16 md:w-20 md:h-20 mt-2 mx-auto border bg-[radial-gradient(circle,_#0F1D5A_0%,_#0C8CE9_100%)] rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 md:w-12 md:h-12" viewBox="0 0 24 24">
                            ...
                            <form onSubmit={handleSubmit} className="w-full flex flex-col items-center"> 
                                <div className="mt-2 mb-2 text-center w-full flex flex-col items-center">
                                    {/* Textes adaptatifs : plus petits sur mobile, plus grands sur md */}
                                    <p className="text-2xl md:text-3xl font-bold mt-2">Welcome Back !</p>
                                    <p className="text-sm md:text-base text-gray-600 font-medium mb-6">Sign into your account</p>

                                    {/* Les inputs Material UI s'adaptent grâce à sx responsive et la taille de police par défaut */}
                                    <FormControl sx={{ width: '100%', maxWidth: {xs: '100%', sm: '30ch'}, mb: 3 }} variant="outlined">
                                        ...
                                        <OutlinedInput
                                            ...
                                            sx={{
                                                borderRadius: '30px',
                                                '& .MuiOutlinedInput-input': { color: '#000000', fontSize: { xs: '14px', md: '16px' } },
                                                '& .MuiOutlinedInput-notchedOutline': { borderRadius: '30px', borderWidth: '1px', borderStyle: 'solid', borderColor: 'rgba(0, 0, 0, 0.23)' },
                                                '&:hover .MuiOutlinedInput-notchedOutline': { borderColor: '#000000' },
                                                '&.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: '#0C8CE9' },
                                            }}
                                            endAdornment={
                                    ...
                                    {/* Bouton Principal : taille du texte et padding dynamiques via sx réactif */}
                                    <Button 
                                        variant='contained' 
                                        type='submit' 
                                        disabled={loading}
                                    ...
                                    <p className="text-xs md:text-sm font-bold mb-3">Continue with</p>
                                    
                                    {/* Boutons Sociaux : Ajustement de la taille de police (fontSize) et de la largeur selon l'écran */}
                                    <div className="flex flex-col sm:flex-row justify-center w-full max-w-[30ch] gap-3 mb-4">
                                        <Button 
                                            variant="outlined" 
                                            disabled={loading} 
                                            className="w-full" 
                                            color='black' 
                                            sx={{ fontSize: { xs: '13px', md: '14px' }, py: 1, borderRadius: '30px', border: "#ece7e7", backgroundColor: '#ece7e7', textTransform: 'none', fontWeight: 'bold' }} 
                                            startIcon={<GoogleIcon height="1em" />}
                                        >
                                            Google
                                        </Button>
                                        <Button 
                                            ...
                                            color='black' 
                                            sx={{ fontSize: { xs: '13px', md: '14px' }, py: 1, borderRadius: '30px', border: '#ece7e7', backgroundColor: '#ece7e7', textTransform: 'none', fontWeight: 'bold' }} 
                                            startIcon={<GithubDarkIcon height="1em" />}
                                        >
                                            Github
                                        </Button>
                                    </div>
                                    
                                    <p className="text-xs md:text-sm font-bold mt-2">Forgot <a href="https://www.google.com" className='text-blue-600 underline hover:text-blue-800'>password?</a></p>
